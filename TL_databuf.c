...
hashpipe_databuf_t *TL_input_databuf_create(int instance_id, int databuf_id)
{
    ...
    size_t header_size = sizeof(hashpipe_databuf_t)
                       + sizeof(TL_input_header_cache_alignment);
    size_t block_size  = sizeof(TL_input_block_t);
...
hashpipe_databuf_t *TL_output_databuf_create(int instance_id, int databuf_id)
{
    /* Calc databuf sizes */
    size_t header_size = sizeof(hashpipe_databuf_t)
                       + sizeof(TL_output_header_cache_alignment);
    size_t block_size  = sizeof(TL_output_block_t);
